    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(jp.yahooapis.im.V5.ConversionTrackerService.ConversionTrackerService.class.getName());
    ...
    public ConversionTrackerService() {
        super(CONVERSIONTRACKERSERVICE_WSDL_LOCATION, new QName("http://im.yahooapis.jp/V5", "ConversionTrackerService"));
    }
