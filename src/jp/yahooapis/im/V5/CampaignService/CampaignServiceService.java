    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(jp.yahooapis.im.V5.CampaignService.CampaignServiceService.class.getName());
    ...
    public CampaignServiceService() {
        super(CAMPAIGNSERVICESERVICE_WSDL_LOCATION, new QName("http://im.yahooapis.jp/V5", "CampaignServiceService"));
    }
