    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(jp.yahooapis.im.V5.PlacementUrlIdeaService.PlacementUrlIdeaService.class.getName());
    ...
    public PlacementUrlIdeaService() {
        super(PLACEMENTURLIDEASERVICE_WSDL_LOCATION, new QName("http://im.yahooapis.jp/V5", "PlacementUrlIdeaService"));
    }
