...
import jp.yahooapis.im.V5.AdGroupAdService.ApprovalStatus;
import jp.yahooapis.im.V5.AdGroupAdService.Paging;
import jp.yahooapis.im.V5.AdGroupAdService.UserStatus;

/**
 * Sample TestCase for AdGroupAdServiceSampleTest.<br>
...
public class AdGroupAdServiceSampleTest {
  ...
  public void testGet() throws Exception {
    ...
    selector.getApprovalStatuses()
        .addAll(Arrays.asList(ApprovalStatus.APPROVED, ApprovalStatus.APPROVED_WITH_REVIEW, ApprovalStatus.REVIEW, ApprovalStatus.POST_DISAPPROVED, ApprovalStatus.PRE_DISAPPROVED));
