...
import jp.yahooapis.im.V5.MediaService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class MediaServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public MediaServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
