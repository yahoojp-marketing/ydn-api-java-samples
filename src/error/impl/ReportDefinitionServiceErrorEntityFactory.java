...
import jp.yahooapis.im.V5.ReportDefinitionService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class ReportDefinitionServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public ReportDefinitionServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
