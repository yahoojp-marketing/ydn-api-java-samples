...
import jp.yahooapis.im.V5.AdGroupTargetService.Error;
import jp.yahooapis.im.V5.AdGroupTargetService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class AdGroupTargetServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public AdGroupTargetServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
