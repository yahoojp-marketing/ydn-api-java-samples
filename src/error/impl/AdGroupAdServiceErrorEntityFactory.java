...
import jp.yahooapis.im.V5.AdGroupAdService.Error;
import jp.yahooapis.im.V5.AdGroupAdService.ErrorDetail;
import error.ErrorDetailEntity;
import error.ErrorEntity;
import error.ErrorEntityFactory;

public class AdGroupAdServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public AdGroupAdServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
