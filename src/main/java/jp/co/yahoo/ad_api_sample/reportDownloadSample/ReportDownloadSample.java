...
import jp.yahooapis.im.v201812.report.ReportClosedDateRecord;
import jp.yahooapis.im.v201812.report.ReportClosedDateSelector;
import jp.yahooapis.im.v201812.report.ReportClosedDateValue;
import jp.yahooapis.im.v201812.report.ReportJobOperation;
import jp.yahooapis.im.v201812.report.ReportJobStatus;
import jp.yahooapis.im.v201812.report.ReportPage;
import jp.yahooapis.im.v201812.report.ReportRecord;
import jp.yahooapis.im.v201812.report.ReportReturnValue;
import jp.yahooapis.im.v201812.report.ReportSelector;
import jp.yahooapis.im.v201812.report.ReportServiceInterface;
import jp.yahooapis.im.v201812.report.ReportServiceService;
import jp.yahooapis.im.v201812.report.ReportValues;
import jp.yahooapis.im.v201812.reportdefinition.Operator;
import jp.yahooapis.im.v201812.reportdefinition.ReportAddTemplate;
import jp.yahooapis.im.v201812.reportdefinition.ReportCategory;
import jp.yahooapis.im.v201812.reportdefinition.ReportDateRangeType;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinition;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionField;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionFieldValue;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionOperation;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionReturnValue;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionServiceInterface;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionServiceService;
import jp.yahooapis.im.v201812.reportdefinition.ReportDefinitionValues;
import jp.yahooapis.im.v201812.reportdefinition.ReportDownloadEncode;
import jp.yahooapis.im.v201812.reportdefinition.ReportDownloadFormat;
import jp.yahooapis.im.v201812.reportdefinition.ReportFrequencyRange;
import jp.yahooapis.im.v201812.reportdefinition.ReportLang;
...
public class ReportDownloadSample {
  ...
  public static void main(String[] args) {
    try {
      ...
      Holder<List<jp.yahooapis.im.v201812.Error>> getClosedDateErrorHolder = new Holder<List<jp.yahooapis.im.v201812.Error>>();
      ...
      addReportOperation.setOperator(jp.yahooapis.im.v201812.report.Operator.ADD);
      ...
      Holder<List<jp.yahooapis.im.v201812.Error>> addReportError = new Holder<List<jp.yahooapis.im.v201812.Error>>();
      ...
      for (int i = 0; i < 30; i++) {
        ...
        Holder<List<jp.yahooapis.im.v201812.Error>> getReportError = new Holder<List<jp.yahooapis.im.v201812.Error>>();
      ...
      addFrequencyReportOperation.setOperator(jp.yahooapis.im.v201812.report.Operator.ADD);
      ...
      Holder<List<jp.yahooapis.im.v201812.Error>> addFrequencyReportError = new Holder<List<jp.yahooapis.im.v201812.Error>>();
      ...
      removeReportOperation.setOperator(jp.yahooapis.im.v201812.report.Operator.REMOVE);
      ...
      Holder<List<jp.yahooapis.im.v201812.Error>> removeReportError = new Holder<List<jp.yahooapis.im.v201812.Error>>();
      ...
      removeFrequencyReportOperation.setOperator(jp.yahooapis.im.v201812.report.Operator.REMOVE);
      ...
      Holder<List<jp.yahooapis.im.v201812.Error>> removeFrequencyReportError = new Holder<List<jp.yahooapis.im.v201812.Error>>();
