...
import jp.yahooapis.im.V5.StatsService.Error;
import jp.yahooapis.im.V5.StatsService.ErrorDetail;

public class StatsServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;


  public StatsServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
