...
import jp.yahooapis.im.V5.AccountService.ErrorDetail;

public class AccountServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public AccountServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
