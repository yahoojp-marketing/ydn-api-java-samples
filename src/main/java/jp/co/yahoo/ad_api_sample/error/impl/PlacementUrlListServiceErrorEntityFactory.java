...
import jp.yahooapis.im.V5.PlacementUrlListService.Error;
import jp.yahooapis.im.V5.PlacementUrlListService.ErrorDetail;

public class PlacementUrlListServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;


  public PlacementUrlListServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
