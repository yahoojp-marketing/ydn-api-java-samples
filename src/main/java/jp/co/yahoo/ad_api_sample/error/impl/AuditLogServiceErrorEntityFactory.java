...
import jp.yahooapis.im.V5.AuditLogService.ErrorDetail;

public class AuditLogServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public AuditLogServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
