...
import jp.yahooapis.im.V6.VideoService.ErrorDetail;

import java.util.ArrayList;
import java.util.List;

public class VideoServiceErrorEntityFactory implements ErrorEntityFactory {

  private final List<Error> errors;

  public VideoServiceErrorEntityFactory(List<Error> errors) {
    this.errors = errors;
  }
