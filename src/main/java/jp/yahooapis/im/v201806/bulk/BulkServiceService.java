 ...
 * 
 */
@WebServiceClient(name = "BulkServiceService", targetNamespace = "http://im.yahooapis.jp/V201806/Bulk", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201806/BulkService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BULKSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201806/Bulk", "BulkServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201806/BulkService?wsdl");
    ...
    public BulkServiceInterface getBulkService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/Bulk", "BulkService"), BulkServiceInterface.class);
    }
    ...
    public BulkServiceInterface getBulkService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/Bulk", "BulkService"), BulkServiceInterface.class, features);
    }
