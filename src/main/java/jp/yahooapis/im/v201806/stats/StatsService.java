 ...
 * 
 */
@WebServiceClient(name = "StatsService", targetNamespace = "http://im.yahooapis.jp/V201806/Stats", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201806/StatsService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STATSSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201806/Stats", "StatsService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201806/StatsService?wsdl");
    ...
    public StatsServiceInterface getStatsService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/Stats", "StatsService"), StatsServiceInterface.class);
    }
    ...
    public StatsServiceInterface getStatsService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/Stats", "StatsService"), StatsServiceInterface.class, features);
    }
