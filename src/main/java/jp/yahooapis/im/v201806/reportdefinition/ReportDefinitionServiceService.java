 ...
 * 
 */
@WebServiceClient(name = "ReportDefinitionServiceService", targetNamespace = "http://im.yahooapis.jp/V201806/ReportDefinition", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201806/ReportDefinitionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDEFINITIONSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201806/ReportDefinition", "ReportDefinitionServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201806/ReportDefinitionService?wsdl");
    ...
    public ReportDefinitionServiceInterface getReportDefinitionService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/ReportDefinition", "ReportDefinitionService"), ReportDefinitionServiceInterface.class);
    }
    ...
    public ReportDefinitionServiceInterface getReportDefinitionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/ReportDefinition", "ReportDefinitionService"), ReportDefinitionServiceInterface.class, features);
    }
