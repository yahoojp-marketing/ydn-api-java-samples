 ...
 * generated in the jp.yahooapis.im.v201806.campaign package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201806/Campaign", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201806/Campaign", "RequestHeader");
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201806/Campaign", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201806.campaign
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201806/Campaign", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201806/Campaign", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201806/Campaign", name = "ResponseHeader")
