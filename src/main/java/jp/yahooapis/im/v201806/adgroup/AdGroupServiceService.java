 ...
 * 
 */
@WebServiceClient(name = "AdGroupServiceService", targetNamespace = "http://im.yahooapis.jp/V201806/AdGroup", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201806/AdGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201806/AdGroup", "AdGroupServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201806/AdGroupService?wsdl");
    ...
    public AdGroupServiceInterface getAdGroupService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/AdGroup", "AdGroupService"), AdGroupServiceInterface.class);
    }
    ...
    public AdGroupServiceInterface getAdGroupService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201806/AdGroup", "AdGroupService"), AdGroupServiceInterface.class, features);
    }
