 ...
 * generated in the jp.yahooapis.im.v201809.media package. 
...
public class ObjectFactory {
    ...
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201809/Media", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201809/Media", "RequestHeader");
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201809/Media", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201809.media
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/Media", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/Media", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/Media", name = "ResponseHeader")
