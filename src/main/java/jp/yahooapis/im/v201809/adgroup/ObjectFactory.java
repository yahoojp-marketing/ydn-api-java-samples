 ...
 * generated in the jp.yahooapis.im.v201809.adgroup package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201809/AdGroup", "ResponseHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201809/AdGroup", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201809/AdGroup", "RequestHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201809.adgroup
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/AdGroup", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/AdGroup", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/AdGroup", name = "RequestHeader")
