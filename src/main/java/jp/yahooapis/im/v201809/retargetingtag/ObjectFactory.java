 ...
 * generated in the jp.yahooapis.im.v201809.retargetingtag package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201809/RetargetingTag", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201809/RetargetingTag", "ApiExceptionFault");
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201809/RetargetingTag", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201809.retargetingtag
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/RetargetingTag", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/RetargetingTag", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201809/RetargetingTag", name = "ResponseHeader")
