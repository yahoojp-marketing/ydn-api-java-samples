 ...
 * 
 */
@WebServiceClient(name = "ConversionTrackerService", targetNamespace = "http://im.yahooapis.jp/V201809/ConversionTracker", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201809/ConversionTrackerService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CONVERSIONTRACKERSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201809/ConversionTracker", "ConversionTrackerService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201809/ConversionTrackerService?wsdl");
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/ConversionTracker", "ConversionTrackerService"), ConversionTrackerServiceInterface.class);
    }
    ...
    public ConversionTrackerServiceInterface getConversionTrackerService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/ConversionTracker", "ConversionTrackerService"), ConversionTrackerServiceInterface.class, features);
    }
