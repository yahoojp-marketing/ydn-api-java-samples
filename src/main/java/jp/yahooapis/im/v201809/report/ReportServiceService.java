 ...
 * 
 */
@WebServiceClient(name = "ReportServiceService", targetNamespace = "http://im.yahooapis.jp/V201809/Report", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201809/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201809/Report", "ReportServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201809/ReportService?wsdl");
    ...
    public ReportServiceInterface getReportService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/Report", "ReportService"), ReportServiceInterface.class);
    }
    ...
    public ReportServiceInterface getReportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/Report", "ReportService"), ReportServiceInterface.class, features);
    }
