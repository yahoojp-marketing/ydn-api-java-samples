 ...
 * 
 */
@WebServiceClient(name = "PlacementUrlIdeaService", targetNamespace = "http://im.yahooapis.jp/V201809/PlacementUrlIdea", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201809/PlacementUrlIdeaService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PLACEMENTURLIDEASERVICE_QNAME = new QName("http://im.yahooapis.jp/V201809/PlacementUrlIdea", "PlacementUrlIdeaService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201809/PlacementUrlIdeaService?wsdl");
    ...
    public PlacementUrlIdeaServiceInterface getPlacementUrlIdeaService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/PlacementUrlIdea", "PlacementUrlIdeaService"), PlacementUrlIdeaServiceInterface.class);
    }
    ...
    public PlacementUrlIdeaServiceInterface getPlacementUrlIdeaService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/PlacementUrlIdea", "PlacementUrlIdeaService"), PlacementUrlIdeaServiceInterface.class, features);
    }
