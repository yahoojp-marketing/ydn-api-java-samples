 ...
 *         &lt;element name="child" type="{http://im.yahooapis.jp/V201809/Dictionary}GeographicLocation" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GeographicLocation {
    ...
    protected List<GeographicLocation> child;
     ...
     * 
     */
    public List<GeographicLocation> getChild() {
        if (child == null) {
            child = new ArrayList<GeographicLocation>();
        }
        return this.child;
    }
