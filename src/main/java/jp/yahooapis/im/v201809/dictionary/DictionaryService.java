 ...
 * 
 */
@WebServiceClient(name = "DictionaryService", targetNamespace = "http://im.yahooapis.jp/V201809/Dictionary", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201809/DictionaryService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName DICTIONARYSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201809/Dictionary", "DictionaryService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201809/DictionaryService?wsdl");
    ...
    public DictionaryServiceInterface getDictionaryService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/Dictionary", "DictionaryService"), DictionaryServiceInterface.class);
    }
    ...
    public DictionaryServiceInterface getDictionaryService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201809/Dictionary", "DictionaryService"), DictionaryServiceInterface.class, features);
    }
