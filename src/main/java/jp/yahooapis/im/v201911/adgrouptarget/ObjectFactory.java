 ...
 * generated in the jp.yahooapis.im.v201911.adgrouptarget package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201911/AdGroupTarget", "ResponseHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201911/AdGroupTarget", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201911/AdGroupTarget", "RequestHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201911.adgrouptarget
     * 
     */
    ...
    /**
     * Create an instance of {@link AudienceCategoryTarget }
     * 
     */
    public AudienceCategoryTarget createAudienceCategoryTarget() {
        return new AudienceCategoryTarget();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201911/AdGroupTarget", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201911/AdGroupTarget", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201911/AdGroupTarget", name = "RequestHeader")
