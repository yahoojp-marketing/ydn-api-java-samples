 ...
 *       &lt;sequence>
 *         &lt;element name="fields" type="{http://im.yahooapis.jp/V201911/ReportDefinition}ReportFieldAttribute" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
    ...
    extends ReturnValue
{
    ...
    protected List<ReportFieldAttribute> fields;
     ...
     * {@link ReportFieldAttribute }
     * 
     * 
     */
    public List<ReportFieldAttribute> getFields() {
        if (fields == null) {
            fields = new ArrayList<ReportFieldAttribute>();
        }
        return this.fields;
    }
