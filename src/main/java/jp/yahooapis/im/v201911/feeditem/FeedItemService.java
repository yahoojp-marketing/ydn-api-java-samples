 ...
 * 
 */
@WebServiceClient(name = "FeedItemService", targetNamespace = "http://im.yahooapis.jp/V201911/FeedItem", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201911/FeedItemService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDITEMSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201911/FeedItem", "FeedItemService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201911/FeedItemService?wsdl");
    ...
    public FeedItemServiceInterface getFeedItemService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201911/FeedItem", "FeedItemService"), FeedItemServiceInterface.class);
    }
    ...
    public FeedItemServiceInterface getFeedItemService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201911/FeedItem", "FeedItemService"), FeedItemServiceInterface.class, features);
    }
