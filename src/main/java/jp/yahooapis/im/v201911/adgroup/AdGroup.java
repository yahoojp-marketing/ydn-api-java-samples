 ...
 *         &lt;element name="userStatus" type="{http://im.yahooapis.jp/V201911/AdGroup}UserStatus" minOccurs="0"/>
 *         &lt;element name="bid" type="{http://im.yahooapis.jp/V201911/AdGroup}AdGroupBid" minOccurs="0"/>
 *         &lt;element name="conversionOptimizer" type="{http://im.yahooapis.jp/V201911/AdGroup}AdGroupConversionOptimizer" minOccurs="0"/>
 *         &lt;element name="device" type="{http://im.yahooapis.jp/V201911/AdGroup}DeviceType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deviceApp" type="{http://im.yahooapis.jp/V201911/AdGroup}DeviceAppType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deviceOs" type="{http://im.yahooapis.jp/V201911/AdGroup}DeviceOsType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="smartDeviceCarriers" type="{http://im.yahooapis.jp/V201911/AdGroup}SmartDeviceCarrier" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="deviceOsVersion" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="dynamicImageExtensions" type="{http://im.yahooapis.jp/V201911/AdGroup}DynamicImageExtensions" minOccurs="0"/>
 *         &lt;element name="labels" type="{http://im.yahooapis.jp/V201911/AdGroup}Label" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="adGroupBiddingStrategy" type="{http://im.yahooapis.jp/V201911/AdGroup}AdGroupBiddingStrategy" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AdGroup {
    ...
    protected AdGroupBiddingStrategy adGroupBiddingStrategy;
    ...
    /**
     * Gets the value of the adGroupBiddingStrategy property.
     * 
     * @return
     *     possible object is
     ...
     *     
     */
    public AdGroupBiddingStrategy getAdGroupBiddingStrategy() {
        return adGroupBiddingStrategy;
    }

    /**
     * Sets the value of the adGroupBiddingStrategy property.
     * 
     * @param value
     *     allowed object is
     *     {@link AdGroupBiddingStrategy }
     *     
     */
    public void setAdGroupBiddingStrategy(AdGroupBiddingStrategy value) {
        this.adGroupBiddingStrategy = value;
    }
