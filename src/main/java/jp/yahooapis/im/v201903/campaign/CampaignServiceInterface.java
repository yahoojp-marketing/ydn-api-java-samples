...
@XmlSeeAlso({
    ...
    jp.yahooapis.im.v201903.campaign.ObjectFactory.class
})
public interface CampaignServiceInterface {
    ...
    public void get(
        @WebParam(name = "selector", targetNamespace = "http://im.yahooapis.jp/V201903/Campaign")
        CampaignSelector selector,
        @WebParam(name = "rval", targetNamespace = "http://im.yahooapis.jp/V201903/Campaign", mode = WebParam.Mode.OUT)
        Holder<CampaignPage> rval,
        @WebParam(name = "error", targetNamespace = "http://im.yahooapis.jp/V201903/Campaign", mode = WebParam.Mode.OUT)
    ...
    public void mutate(
        @WebParam(name = "operations", targetNamespace = "http://im.yahooapis.jp/V201903/Campaign")
