 ...
 * 
 */
@WebServiceClient(name = "LabelService", targetNamespace = "http://im.yahooapis.jp/V201903/Label", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/LabelService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LABELSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/Label", "LabelService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/LabelService?wsdl");
    ...
    public LabelServiceInterface getLabelService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Label", "LabelService"), LabelServiceInterface.class);
    }
    ...
    public LabelServiceInterface getLabelService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Label", "LabelService"), LabelServiceInterface.class, features);
    }
