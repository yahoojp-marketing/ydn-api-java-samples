 ...
 * generated in the jp.yahooapis.im.v201903.retargetinglist package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201903/RetargetingList", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201903/RetargetingList", "ApiExceptionFault");
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201903/RetargetingList", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201903.retargetinglist
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201903/RetargetingList", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201903/RetargetingList", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201903/RetargetingList", name = "ResponseHeader")
