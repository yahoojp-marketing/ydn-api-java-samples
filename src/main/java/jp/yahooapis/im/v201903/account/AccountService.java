 ...
 * 
 */
@WebServiceClient(name = "AccountService", targetNamespace = "http://im.yahooapis.jp/V201903/Account", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/AccountService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/Account", "AccountService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/AccountService?wsdl");
    ...
    public AccountServiceInterface getAccountService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Account", "AccountService"), AccountServiceInterface.class);
    }
    ...
    public AccountServiceInterface getAccountService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Account", "AccountService"), AccountServiceInterface.class, features);
    }
