 ...
 * 
 */
@WebServiceClient(name = "FeedDataService", targetNamespace = "http://im.yahooapis.jp/V201903/FeedData", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/FeedDataService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDDATASERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/FeedData", "FeedDataService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/FeedDataService?wsdl");
    ...
    public FeedDataServiceInterface getFeedDataService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/FeedData", "FeedDataService"), FeedDataServiceInterface.class);
    }
    ...
    public FeedDataServiceInterface getFeedDataService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/FeedData", "FeedDataService"), FeedDataServiceInterface.class, features);
    }
