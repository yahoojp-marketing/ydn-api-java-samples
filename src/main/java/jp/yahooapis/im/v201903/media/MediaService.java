 ...
 * 
 */
@WebServiceClient(name = "MediaService", targetNamespace = "http://im.yahooapis.jp/V201903/Media", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/MediaService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MEDIASERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/Media", "MediaService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/MediaService?wsdl");
    ...
    public MediaServiceInterface getMediaService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Media", "MediaService"), MediaServiceInterface.class);
    }
    ...
    public MediaServiceInterface getMediaService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Media", "MediaService"), MediaServiceInterface.class, features);
    }
