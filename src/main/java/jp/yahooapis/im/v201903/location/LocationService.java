 ...
 * 
 */
@WebServiceClient(name = "LocationService", targetNamespace = "http://im.yahooapis.jp/V201903/Location", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/LocationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOCATIONSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/Location", "LocationService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/LocationService?wsdl");
    ...
    public LocationServiceInterface getLocationService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Location", "LocationService"), LocationServiceInterface.class);
    }
    ...
    public LocationServiceInterface getLocationService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Location", "LocationService"), LocationServiceInterface.class, features);
    }
