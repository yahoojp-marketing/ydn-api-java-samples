 ...
 * 
 */
@WebServiceClient(name = "ReportService", targetNamespace = "http://im.yahooapis.jp/V201903/Report", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/Report", "ReportService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/ReportService?wsdl");
    ...
    public ReportServiceInterface getReportService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Report", "ReportService"), ReportServiceInterface.class);
    }
    ...
    public ReportServiceInterface getReportService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/Report", "ReportService"), ReportServiceInterface.class, features);
    }
