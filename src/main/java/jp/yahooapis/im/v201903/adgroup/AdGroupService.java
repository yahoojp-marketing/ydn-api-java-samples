 ...
 * 
 */
@WebServiceClient(name = "AdGroupService", targetNamespace = "http://im.yahooapis.jp/V201903/AdGroup", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201903/AdGroupService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201903/AdGroup", "AdGroupService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201903/AdGroupService?wsdl");
    ...
    public AdGroupServiceInterface getAdGroupService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/AdGroup", "AdGroupService"), AdGroupServiceInterface.class);
    }
    ...
    public AdGroupServiceInterface getAdGroupService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201903/AdGroup", "AdGroupService"), AdGroupServiceInterface.class, features);
    }
