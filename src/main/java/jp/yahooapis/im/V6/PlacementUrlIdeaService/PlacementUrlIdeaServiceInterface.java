 ...
 * 
 */
@WebService(name = "PlacementUrlIdeaServiceInterface", targetNamespace = "http://im.yahooapis.jp/V6")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface PlacementUrlIdeaServiceInterface {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "get", targetNamespace = "http://im.yahooapis.jp/V6", className = "jp.yahooapis.im.V6.PlacementUrlIdeaService.Get")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "http://im.yahooapis.jp/V6", className = "jp.yahooapis.im.V6.PlacementUrlIdeaService.GetResponse")
    public void get(
