 ...
 * 
 */
@WebService(name = "AccountAdProductServiceInterface", targetNamespace = "http://im.yahooapis.jp/V6")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface AccountAdProductServiceInterface {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "get", targetNamespace = "http://im.yahooapis.jp/V6", className = "jp.yahooapis.im.V6.AccountAdProductService.Get")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "http://im.yahooapis.jp/V6", className = "jp.yahooapis.im.V6.AccountAdProductService.GetResponse")
    public void get(
