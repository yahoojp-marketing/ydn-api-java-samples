 ...
 * generated in the jp.yahooapis.im.V6.ReportService package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.V6.ReportService
     * 
     */
