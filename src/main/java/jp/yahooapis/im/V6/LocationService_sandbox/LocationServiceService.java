 ...
 * 
 */
@WebServiceClient(name = "LocationServiceService", targetNamespace = "http://im.yahooapis.jp/V6", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V6.0/LocationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOCATIONSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V6", "LocationServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V6.0/LocationService?wsdl");
    ...
    public LocationServiceInterface getLocationService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "LocationService"), LocationServiceInterface.class);
    }
    ...
    public LocationServiceInterface getLocationService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "LocationService"), LocationServiceInterface.class, features);
    }
