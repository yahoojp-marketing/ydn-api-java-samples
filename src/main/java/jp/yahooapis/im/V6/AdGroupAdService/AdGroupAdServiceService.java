    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V6", "AdGroupAdServiceService");
    ...
    public AdGroupAdServiceInterface getAdGroupAdService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "AdGroupAdService"), AdGroupAdServiceInterface.class);
    }
    ...
    public AdGroupAdServiceInterface getAdGroupAdService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "AdGroupAdService"), AdGroupAdServiceInterface.class, features);
    }
