 ...
 *         &lt;element name="dateRangeType" type="{http://im.yahooapis.jp/V6}ReportDateRangeType" minOccurs="0"/>
 *         &lt;element name="dateRange" type="{http://im.yahooapis.jp/V6}ReportDateRange" minOccurs="0"/>
 *         &lt;element name="frequencyRange" type="{http://im.yahooapis.jp/V6}ReportFrequencyRange" minOccurs="0"/>
 *         &lt;element name="filters" type="{http://im.yahooapis.jp/V6}ReportFilter" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="format" type="{http://im.yahooapis.jp/V6}ReportDownloadFormat" minOccurs="0"/>
 *         &lt;element name="encode" type="{http://im.yahooapis.jp/V6}ReportDownloadEncode" minOccurs="0"/>
 *         &lt;element name="zip" type="{http://im.yahooapis.jp/V6}ReportZip" minOccurs="0"/>
 *         &lt;element name="lang" type="{http://im.yahooapis.jp/V6}ReportLang" minOccurs="0"/>
 *         &lt;element name="intervalType" type="{http://im.yahooapis.jp/V6}ReportIntervalType" minOccurs="0"/>
 *         &lt;element name="specifyDay" type="{http://www.w3.org/2001/XMLSchema}int" minOccurs="0"/>
 *         &lt;element name="addTemplate" type="{http://im.yahooapis.jp/V6}ReportAddTemplate" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
