    ...
    extends Service
{
    ...
    private final static QName RETARGETINGLISTSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V6", "RetargetingListServiceService");
    ...
    public RetargetingListServiceInterface getRetargetingListService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "RetargetingListService"), RetargetingListServiceInterface.class);
    }
    ...
    public RetargetingListServiceInterface getRetargetingListService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "RetargetingListService"), RetargetingListServiceInterface.class, features);
    }
