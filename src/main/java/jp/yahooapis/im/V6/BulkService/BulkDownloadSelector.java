 ...
 *         &lt;element name="campaignUserStatuses" type="{http://im.yahooapis.jp/V6}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="adGroupUserStatuses" type="{http://im.yahooapis.jp/V6}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="adGroupAdUserStatuses" type="{http://im.yahooapis.jp/V6}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="mediaUserStatuses" type="{http://im.yahooapis.jp/V6}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="adGroupAdApprovalStatuses" type="{http://im.yahooapis.jp/V6}ApprovalStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="mediaApprovalStatuses" type="{http://im.yahooapis.jp/V6}MediaApprovalStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="entityTypes" type="{http://im.yahooapis.jp/V6}EntityType" minOccurs="0"/>
 *         &lt;element name="downloadBulkJob" type="{http://im.yahooapis.jp/V6}DownloadBulkJob" minOccurs="0"/>
 *         &lt;element name="downloadType" type="{http://im.yahooapis.jp/V6}BulkDownloadType" minOccurs="0"/>
