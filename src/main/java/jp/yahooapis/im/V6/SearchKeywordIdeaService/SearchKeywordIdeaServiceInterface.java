 ...
 * 
 */
@WebService(name = "SearchKeywordIdeaServiceInterface", targetNamespace = "http://im.yahooapis.jp/V6")
@XmlSeeAlso({
    ObjectFactory.class
})
public interface SearchKeywordIdeaServiceInterface {
     ...
     */
    @WebMethod
    @RequestWrapper(localName = "get", targetNamespace = "http://im.yahooapis.jp/V6", className = "jp.yahooapis.im.V6.SearchKeywordIdeaService.Get")
    @ResponseWrapper(localName = "getResponse", targetNamespace = "http://im.yahooapis.jp/V6", className = "jp.yahooapis.im.V6.SearchKeywordIdeaService.GetResponse")
    public void get(
