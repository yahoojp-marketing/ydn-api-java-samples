 ...
 * 
 */
@WebServiceClient(name = "AccountServiceService", targetNamespace = "http://im.yahooapis.jp/V6", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V6.1/AccountService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V6", "AccountServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V6.1/AccountService?wsdl");
    ...
    public AccountServiceInterface getAccountService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "AccountService"), AccountServiceInterface.class);
    }
    ...
    public AccountServiceInterface getAccountService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V6", "AccountService"), AccountServiceInterface.class, features);
    }
