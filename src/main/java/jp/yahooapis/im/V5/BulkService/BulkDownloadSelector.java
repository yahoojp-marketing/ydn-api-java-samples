 ...
 *         &lt;element name="campaignUserStatuses" type="{http://im.yahooapis.jp/V5}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="adGroupUserStatuses" type="{http://im.yahooapis.jp/V5}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="adGroupAdUserStatuses" type="{http://im.yahooapis.jp/V5}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="mediaUserStatuses" type="{http://im.yahooapis.jp/V5}UserStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="adGroupAdApprovalStatuses" type="{http://im.yahooapis.jp/V5}ApprovalStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="mediaApprovalStatuses" type="{http://im.yahooapis.jp/V5}MediaApprovalStatus" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="entityTypes" type="{http://im.yahooapis.jp/V5}EntityType" minOccurs="0"/>
 *         &lt;element name="downloadBulkJob" type="{http://im.yahooapis.jp/V5}DownloadBulkJob" minOccurs="0"/>
 *         &lt;element name="downloadType" type="{http://im.yahooapis.jp/V5}BulkDownloadType" minOccurs="0"/>
 *         &lt;element name="lang" type="{http://im.yahooapis.jp/V5}BulkLang" minOccurs="0"/>
 *         &lt;element name="output" type="{http://im.yahooapis.jp/V5}BulkOutput"/>
 *         &lt;element name="encoding" type="{http://im.yahooapis.jp/V5}BulkEncoding"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
