 ...
 * 
 */
@WebServiceClient(name = "BulkServiceService", targetNamespace = "http://im.yahooapis.jp/V5", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V5.3/BulkService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BULKSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V5", "BulkServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V5.3/BulkService?wsdl");
