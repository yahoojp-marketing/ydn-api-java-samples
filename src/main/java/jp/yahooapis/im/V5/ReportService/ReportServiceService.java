 ...
 * 
 */
@WebServiceClient(name = "ReportServiceService", targetNamespace = "http://im.yahooapis.jp/V5", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V5.3/ReportService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V5", "ReportServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V5.3/ReportService?wsdl");
