 ...
 * 
 */
@WebServiceClient(name = "BulkService", targetNamespace = "http://im.yahooapis.jp/V201907/Bulk", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201907/BulkService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BULKSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201907/Bulk", "BulkService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201907/BulkService?wsdl");
    ...
    public BulkServiceInterface getBulkService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/Bulk", "BulkService"), BulkServiceInterface.class);
    }
    ...
    public BulkServiceInterface getBulkService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/Bulk", "BulkService"), BulkServiceInterface.class, features);
    }
