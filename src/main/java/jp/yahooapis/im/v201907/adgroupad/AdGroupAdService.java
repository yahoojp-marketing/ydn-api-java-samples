 ...
 * 
 */
@WebServiceClient(name = "AdGroupAdService", targetNamespace = "http://im.yahooapis.jp/V201907/AdGroupAd", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201907/AdGroupAdService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201907/AdGroupAd", "AdGroupAdService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201907/AdGroupAdService?wsdl");
    ...
    public AdGroupAdServiceInterface getAdGroupAdService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class);
    }
    ...
    public AdGroupAdServiceInterface getAdGroupAdService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class, features);
    }
