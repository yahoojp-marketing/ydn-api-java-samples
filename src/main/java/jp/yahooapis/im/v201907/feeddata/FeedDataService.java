 ...
 * 
 */
@WebServiceClient(name = "FeedDataService", targetNamespace = "http://im.yahooapis.jp/V201907/FeedData", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201907/FeedDataService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDDATASERVICE_QNAME = new QName("http://im.yahooapis.jp/V201907/FeedData", "FeedDataService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201907/FeedDataService?wsdl");
    ...
    public FeedDataServiceInterface getFeedDataService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/FeedData", "FeedDataService"), FeedDataServiceInterface.class);
    }
    ...
    public FeedDataServiceInterface getFeedDataService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/FeedData", "FeedDataService"), FeedDataServiceInterface.class, features);
    }
