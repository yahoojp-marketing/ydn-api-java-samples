 ...
 * generated in the jp.yahooapis.im.v201907.reportdefinition package. 
...
public class ObjectFactory {
    ...
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201907/ReportDefinition", "RequestHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201907/ReportDefinition", "ApiExceptionFault");
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201907/ReportDefinition", "ResponseHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201907.reportdefinition
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201907/ReportDefinition", name = "RequestHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201907/ReportDefinition", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201907/ReportDefinition", name = "ResponseHeader")
