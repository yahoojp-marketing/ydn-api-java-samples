 ...
 * 
 */
@WebServiceClient(name = "ReportDefinitionService", targetNamespace = "http://im.yahooapis.jp/V201907/ReportDefinition", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201907/ReportDefinitionService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName REPORTDEFINITIONSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201907/ReportDefinition", "ReportDefinitionService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201907/ReportDefinitionService?wsdl");
    ...
    public ReportDefinitionServiceInterface getReportDefinitionService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/ReportDefinition", "ReportDefinitionService"), ReportDefinitionServiceInterface.class);
    }
    ...
    public ReportDefinitionServiceInterface getReportDefinitionService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/ReportDefinition", "ReportDefinitionService"), ReportDefinitionServiceInterface.class, features);
    }
