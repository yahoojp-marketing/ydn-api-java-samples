 ...
 * 
 */
@WebServiceClient(name = "FeedHolderService", targetNamespace = "http://im.yahooapis.jp/V201907/FeedHolder", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201907/FeedHolderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName FEEDHOLDERSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201907/FeedHolder", "FeedHolderService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201907/FeedHolderService?wsdl");
    ...
    public FeedHolderServiceInterface getFeedHolderService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/FeedHolder", "FeedHolderService"), FeedHolderServiceInterface.class);
    }
    ...
    public FeedHolderServiceInterface getFeedHolderService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/FeedHolder", "FeedHolderService"), FeedHolderServiceInterface.class, features);
    }
