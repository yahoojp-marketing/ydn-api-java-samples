 ...
 * generated in the jp.yahooapis.im.v201907.conversiontracker package. 
...
public class ObjectFactory {
    ...
    private final static QName _ResponseHeader_QNAME = new QName("http://im.yahooapis.jp/V201907/ConversionTracker", "ResponseHeader");
    private final static QName _ApiExceptionFault_QNAME = new QName("http://im.yahooapis.jp/V201907/ConversionTracker", "ApiExceptionFault");
    private final static QName _RequestHeader_QNAME = new QName("http://im.yahooapis.jp/V201907/ConversionTracker", "RequestHeader");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: jp.yahooapis.im.v201907.conversiontracker
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201907/ConversionTracker", name = "ResponseHeader")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201907/ConversionTracker", name = "ApiExceptionFault")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://im.yahooapis.jp/V201907/ConversionTracker", name = "RequestHeader")
