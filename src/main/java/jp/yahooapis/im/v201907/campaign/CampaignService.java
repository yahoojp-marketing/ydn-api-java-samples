 ...
 * 
 */
@WebServiceClient(name = "CampaignService", targetNamespace = "http://im.yahooapis.jp/V201907/Campaign", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201907/CampaignService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CAMPAIGNSERVICE_QNAME = new QName("http://im.yahooapis.jp/V201907/Campaign", "CampaignService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201907/CampaignService?wsdl");
    ...
    public CampaignServiceInterface getCampaignService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/Campaign", "CampaignService"), CampaignServiceInterface.class);
    }
    ...
    public CampaignServiceInterface getCampaignService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201907/Campaign", "CampaignService"), CampaignServiceInterface.class, features);
    }
