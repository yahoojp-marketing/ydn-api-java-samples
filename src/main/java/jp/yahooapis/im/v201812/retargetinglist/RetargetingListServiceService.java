 ...
 * 
 */
@WebServiceClient(name = "RetargetingListServiceService", targetNamespace = "http://im.yahooapis.jp/V201812/RetargetingList", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201812/RetargetingListService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName RETARGETINGLISTSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201812/RetargetingList", "RetargetingListServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201812/RetargetingListService?wsdl");
    ...
    public RetargetingListServiceInterface getRetargetingListService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/RetargetingList", "RetargetingListService"), RetargetingListServiceInterface.class);
    }
    ...
    public RetargetingListServiceInterface getRetargetingListService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/RetargetingList", "RetargetingListService"), RetargetingListServiceInterface.class, features);
    }
