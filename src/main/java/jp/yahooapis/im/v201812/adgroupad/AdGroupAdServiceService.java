 ...
 * 
 */
@WebServiceClient(name = "AdGroupAdServiceService", targetNamespace = "http://im.yahooapis.jp/V201812/AdGroupAd", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201812/AdGroupAdService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ADGROUPADSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201812/AdGroupAd", "AdGroupAdServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201812/AdGroupAdService?wsdl");
    ...
    public AdGroupAdServiceInterface getAdGroupAdService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class);
    }
    ...
    public AdGroupAdServiceInterface getAdGroupAdService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/AdGroupAd", "AdGroupAdService"), AdGroupAdServiceInterface.class, features);
    }
