 ...
 * 
 */
@WebServiceClient(name = "LocationServiceService", targetNamespace = "http://im.yahooapis.jp/V201812/Location", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201812/LocationService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName LOCATIONSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201812/Location", "LocationServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201812/LocationService?wsdl");
    ...
    public LocationServiceInterface getLocationService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/Location", "LocationService"), LocationServiceInterface.class);
    }
    ...
    public LocationServiceInterface getLocationService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/Location", "LocationService"), LocationServiceInterface.class, features);
    }
