 ...
 * 
 */
@WebServiceClient(name = "AccountServiceService", targetNamespace = "http://im.yahooapis.jp/V201812/Account", wsdlLocation = "https://sandbox.im.yahooapis.jp/services/V201812/AccountService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ACCOUNTSERVICESERVICE_QNAME = new QName("http://im.yahooapis.jp/V201812/Account", "AccountServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("https://sandbox.im.yahooapis.jp/services/V201812/AccountService?wsdl");
    ...
    public AccountServiceInterface getAccountService() {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/Account", "AccountService"), AccountServiceInterface.class);
    }
    ...
    public AccountServiceInterface getAccountService(WebServiceFeature... features) {
        return super.getPort(new QName("http://im.yahooapis.jp/V201812/Account", "AccountService"), AccountServiceInterface.class, features);
    }
